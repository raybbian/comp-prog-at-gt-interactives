 ...
 *
 * The code is checked here rather than on the way to a team, because a mistyped room is the
 * one mistake that fails silently in every other design: the object behind a name exists the
 * moment anyone asks for it, so a wrong digit would drop someone into an empty meeting of
 * their own where the host never appears and nothing is obviously broken.
 */
