...
export default defineConfig({
  ...
  base: './',
  // Pinned so this can run alongside the other four interactives. Telephone holds 5176
  // and 8787; this one takes the next of each, so both games can be up at once on one
  // laptop while a meeting is being rehearsed.
  server: {
    port: 5177,
  ...
  preview: { port: 4177, allowedHosts: ['.trycloudflare.com'] },
});
